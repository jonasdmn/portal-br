...
export default function PortalNoticias() {
  ...
  return (
    <div style={S.root}>
      ...
      {/* Location Overlay */}
      {showLocOverlay && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(255,255,255,0.88)", zIndex: 1000, display: "flex", alignItems: "flex-end" }}>
          <div style={{ background: "#fff", width: "100%", height: "25vh", minHeight: 200, padding: "28px 24px", borderTop: "4px solid " + ORANGE, fontFamily: "system-ui,sans-serif", boxSizing: "border-box", boxShadow: "0 -4px 24px rgba(0,0,0,0.15)", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
              <div style={{ fontSize: 17, fontWeight: 700, marginBottom: 10, color: DARK }}>Ative sua localizacao</div>
